...
- Rule:
  ...
  - If GateCR = HARD_FAIL -> S09–S12 = NOT_RUN and output: `structural resolution not found`.
...
- HARD_FAIL -> S09 NOT_RUN, S10 NOT_RUN, S11 NOT_RUN, S12 NOT_RUN with message `structural resolution not found`.
...
- No changes to existing harness code.
- No new pilot/run execution.
